...
### Fixed
- Quest Link connection on Windows Chrome now properly initializes by detecting and responding to the `sessiongranted` event
- VR button now auto-clicks when a WebXR session is already granted (Quest Link scenario)
