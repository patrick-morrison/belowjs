...
import { Controls as _i, Vector3 as R, MOUSE as Ce, TOUCH as pe, Quaternion as Ue, Spherical as xt, Vector2 as O, Ray as Gi, Plane as Pi, MathUtils as bt, TrianglesDrawMode as Ni, TriangleFanDrawMode as at, TriangleStripDrawMode as si, Loader as Ct, LoaderUtils as ve, FileLoader as Ae, MeshPhysicalMaterial as $, Color as ne, LinearSRGBColorSpace as Y, SRGBColorSpace as ie, SpotLight as Ui, PointLight as Oi, DirectionalLight as Vi, Matrix4 as Re, InstancedMesh as Hi, InstancedBufferAttribute as qi, Object3D as It, TextureLoader as ji, ImageBitmapLoader as Ki, BufferAttribute as xe, InterleavedBuffer as zi, InterleavedBufferAttribute as ae, LinearMipmapLinearFilter as Ve, NearestMipmapLinearFilter as Yi, LinearMipmapNearestFilter as Ji, NearestMipmapNearestFilter as Wi, LinearFilter as le, NearestFilter as oi, RepeatWrapping as At, MirroredRepeatWrapping as Xi, ClampToEdgeWrapping as Zi, PointsMaterial as $i, Material as qe, LineBasicMaterial as es, MeshStandardMaterial as ni, DoubleSide as ts, MeshBasicMaterial as fe, PropertyBinding as is, BufferGeometry as ri, SkinnedMesh as ss, Mesh as Et, LineSegments as os, Line as ns, LineLoop as rs, Points as as, Group as je, PerspectiveCamera as As, OrthographicCamera as cs, Skeleton as ls, AnimationClip as hs, Bone as ds, InterpolateDiscrete as gs, InterpolateLinear as ai, Texture as Dt, VectorKeyframeTrack as Rt, NumberKeyframeTrack as Tt, QuaternionKeyframeTrack as kt, ColorManagement as ct, FrontSide as us, Interpolant as ps, Box3 as He, Sphere as Bt, CompressedCubeTexture as fs, CompressedArrayTexture as ms, CompressedTexture as Ai, NoColorSpace as Lt, RGBA_BPTC_Format as lt, RGBA_S3TC_DXT5_Format as ht, RGBA_S3TC_DXT3_Format as Ft, RGB_S3TC_DXT1_Format as _t, RGBA_S3TC_DXT1_Format as dt, RGBA_ASTC_6x6_Format as Gt, RGBA_ASTC_4x4_Format as Ge, RGBA_ETC2_EAC_Format as ci, RGB_ETC2_Format as li, RedFormat as Se, RGFormat as Me, RGBAFormat as me, UnsignedByteType as z, HalfFloatType as be, FloatType as De, DataTexture as bs, Data3DTexture as Cs, RGB_PVRTC_4BPPV1_Format as Is, RGB_ETC1_Format as Es, RGBA_PVRTC_4BPPV1_Format as Bs, RGB_BPTC_UNSIGNED_Format as Qs, SphereGeometry as ws, InstancedBufferGeometry as ys, Float32BufferAttribute as Pt, InstancedInterleavedBuffer as gt, WireframeGeometry as Ss, ShaderMaterial as Ms, ShaderLib as Pe, UniformsUtils as hi, UniformsLib as Ne, Vector4 as Te, Line3 as vs } from "three";
class Qt {
  constructor() {
    this.events = {};
  }
...
const Nt = { type: "change" }, St = { type: "start" }, di = { type: "end" }, ke = new Gi(), Ut = new Pi(), ks = Math.cos(70 * bt.DEG2RAD), L = new R(), U = 2 * Math.PI, v = {
  NONE: -1,
  ROTATE: 0,
  DOLLY: 1,
  PAN: 2,
...
class Ls extends _i {
  ...
  constructor(e, t = null) {
    super(e, t), this.state = v.NONE, this.target = new R(), this.cursor = new R(), this.minDistance = 0, this.maxDistance = 1 / 0, this.minZoom = 0, this.maxZoom = 1 / 0, this.minTargetRadius = 0, this.maxTargetRadius = 1 / 0, this.minPolarAngle = 0, this.maxPolarAngle = Math.PI, this.minAzimuthAngle = -1 / 0, this.maxAzimuthAngle = 1 / 0, this.enableDamping = !1, this.dampingFactor = 0.05, this.enableZoom = !0, this.zoomSpeed = 1, this.enableRotate = !0, this.rotateSpeed = 1, this.keyRotateSpeed = 1, this.enablePan = !0, this.panSpeed = 1, this.screenSpacePanning = !0, this.keyPanSpeed = 7, this.zoomToCursor = !1, this.autoRotate = !1, this.autoRotateSpeed = 2, this.keys = { LEFT: "ArrowLeft", UP: "ArrowUp", RIGHT: "ArrowRight", BOTTOM: "ArrowDown" }, this.mouseButtons = { LEFT: Ce.ROTATE, MIDDLE: Ce.DOLLY, RIGHT: Ce.PAN }, this.touches = { ONE: pe.ROTATE, TWO: pe.DOLLY_PAN }, this.target0 = this.target.clone(), this.position0 = this.object.position.clone(), this.zoom0 = this.object.zoom, this._domElementKeyEvents = null, this._lastPosition = new R(), this._lastQuaternion = new Ue(), this._lastTargetPosition = new R(), this._quat = new Ue().setFromUnitVectors(e.up, new R(0, 1, 0)), this._quatInverse = this._quat.clone().invert(), this._spherical = new xt(), this._sphericalDelta = new xt(), this._scale = 1, this._panOffset = new R(), this._rotateStart = new O(), this._rotateEnd = new O(), this._rotateDelta = new O(), this._panStart = new O(), this._panEnd = new O(), this._panDelta = new O(), this._dollyStart = new O(), this._dollyEnd = new O(), this._dollyDelta = new O(), this._dollyDirection = new R(), this._mouse = new O(), this._performCursorZoom = !1, this._pointers = [], this._pointerPositions = {}, this._controlActive = !1, this._onPointerMove = _s.bind(this), this._onPointerDown = Fs.bind(this), this._onPointerUp = Gs.bind(this), this._onContextMenu = qs.bind(this), this._onMouseWheel = Us.bind(this), this._onKeyDown = Os.bind(this), this._onTouchStart = Vs.bind(this), this._onTouchMove = Hs.bind(this), this._onMouseDown = Ps.bind(this), this._onMouseMove = Ns.bind(this), this._interceptControlDown = js.bind(this), this._interceptControlUp = Ks.bind(this), this.domElement !== null && this.connect(this.domElement), this.update();
  }
  connect(e) {
  ...
  update(e = null) {
    ...
    L.copy(t).sub(this.target), L.applyQuaternion(this._quat), this._spherical.setFromVector3(L), this.autoRotate && this.state === v.NONE && this._rotateLeft(this._getAutoRotationAngle(e)), this.enableDamping ? (this._spherical.theta += this._sphericalDelta.theta * this.dampingFactor, this._spherical.phi += this._sphericalDelta.phi * this.dampingFactor) : (this._spherical.theta += this._sphericalDelta.theta, this._spherical.phi += this._sphericalDelta.phi);
    ...
    if (L.setFromSpherical(this._spherical), L.applyQuaternion(this._quatInverse), t.copy(this.target).add(L), this.object.lookAt(this.target), this.enableDamping === !0 ? (this._sphericalDelta.theta *= 1 - this.dampingFactor, this._sphericalDelta.phi *= 1 - this.dampingFactor, this._panOffset.multiplyScalar(1 - this.dampingFactor)) : (this._sphericalDelta.set(0, 0, 0), this._panOffset.set(0, 0, 0)), this.zoomToCursor && this._performCursorZoom) {
      ...
      if (this.object.isPerspectiveCamera) {
        ...
        A.unproject(this.object), this.object.position.sub(A).add(r), this.object.updateMatrixWorld(), n = L.length();
      } else
        console.warn("WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled."), this.zoomToCursor = !1;
      n !== null && (this.screenSpacePanning ? this.target.set(0, 0, -1).transformDirection(this.object.matrix).multiplyScalar(n).add(this.object.position) : (ke.origin.copy(this.object.position), ke.direction.set(0, 0, -1).transformDirection(this.object.matrix), Math.abs(this.object.up.dot(ke.direction)) < ks ? this.object.lookAt(this.target) : (Ut.setFromNormalAndCoplanarPoint(this.object.up, this.target), ke.intersectPlane(Ut, this.target))));
    } else if (this.object.isOrthographicCamera) {
  ...
  parse(e, t, i, s) {
    ...
    if (typeof e == "string")
      ...
      if (a.decode(new Uint8Array(e, 0, 4)) === ui) {
        try {
          n[y.KHR_BINARY_GLTF] = new uo(e);
        } catch (h) {
          s && s(h);
          return;
        }
        o = JSON.parse(n[y.KHR_BINARY_GLTF].content);
      } else
...
class Js {
  ...
  _loadLight(e) {
    ...
    return A.position.set(0, 0, 0), te(A, a), a.intensity !== void 0 && (A.intensity = a.intensity), A.name = t.createUniqueName(a.name || "light_" + e), s = Promise.resolve(A), t.cache.add(i, s), s;
  }
  getDependency(e, t) {
    if (e === "light")
...
class Zs {
  ...
  getMaterialType(e) {
    ...
    return !i.extensions || !i.extensions[this.name] ? null : $;
  }
  extendMaterialParams(e, t) {
...
class so {
  ...
  extendMaterialParams(e, t) {
    ...
    return t.attenuationColor = new ne().setRGB(r[0], r[1], r[2], Y), Promise.all(o);
  }
}
class oo {
  constructor(e) {
...
class no {
  ...
  extendMaterialParams(e, t) {
    ...
    return t.specularColor = new ne().setRGB(r[0], r[1], r[2], Y), n.specularColorTexture !== void 0 && o.push(i.assignTexture(t, "specularColorMap", n.specularColorTexture, ie)), Promise.all(o);
  }
}
class ro {
  constructor(e) {
...
class go {
  ...
  createNodeMesh(e) {
    ...
    return r.length < 1 ? null : (r.push(this.parser.createNodeMesh(e)), Promise.all(r).then((A) => {
      ...
      for (const f of h) {
        const C = new Re(), I = new R(), p = new Ue(), m = new R(1, 1, 1), E = new Hi(f.geometry, f.material, d);
        for (let b = 0; b < d; b++)
...
const ui = "glTF", we = 12, Vt = { JSON: 1313821514, BIN: 5130562 };
class uo {
  constructor(e) {
...
class pi extends ps {
  ...
  interpolate_(e, t, i, s) {
    ...
    for (let b = 0; b !== r; b++) {
      const B = n[C + b + r], Q = n[C + b + a] * l, w = n[f + b + r], F = n[f + b] * l;
      o[b] = m * B + E * Q + I * w + p * F;
    }
    return o;
  }
...
function wo(c) {
  let e;
  const t = c.extensions && c.extensions[y.KHR_DRACO_MESH_COMPRESSION];
...
class Mo {
  constructor(e = {}, t = {}) {
    ...
    typeof createImageBitmap > "u" || i && s < 17 || o && n < 98 ? this.textureLoader = new ji(this.options.manager) : this.textureLoader = new Ki(this.options.manager), this.textureLoader.setCrossOrigin(this.options.crossOrigin), this.textureLoader.setRequestHeader(this.options.requestHeader), this.fileLoader = new Ae(this.options.manager), this.fileLoader.setResponseType("arraybuffer"), this.options.crossOrigin === "use-credentials" && this.fileLoader.setWithCredentials(!0);
  }
  setExtensions(e) {
    this.extensions = e;
  }
  ...
  parse(e, t) {
    ...
    this.cache.removeAll(), this.nodeCache = {}, this._invokeAll(function(n) {
      ...
      return re(o, r, s), te(r, s), Promise.all(i._invokeAll(function(a) {
  ...
  loadAccessor(e) {
    ...
    return s.bufferView !== void 0 ? o.push(this.getDependency("bufferView", s.bufferView)) : o.push(null), s.sparse !== void 0 && (o.push(this.getDependency("bufferView", s.sparse.indices.bufferView)), o.push(this.getDependency("bufferView", s.sparse.values.bufferView))), Promise.all(o).then(function(n) {
      ...
      if (s.sparse !== void 0) {
        ...
        for (let w = 0, F = B.length; w < F; w++) {
          const D = B[w];
          if (I.setX(D, Q[w * a]), a >= 2 && I.setY(D, Q[w * a + 1]), a >= 3 && I.setZ(D, Q[w * a + 2]), a >= 4 && I.setW(D, Q[w * a + 3]), a >= 5) throw new Error("THREE.GLTFLoader: Unsupported itemSize in sparse BufferAttribute.");
        }
        I.normalized = f;
      }
      return I;
  ...
  loadTextureImage(e, t, i) {
    ...
    const A = this.loadImageSource(t, i).then(function(l) {
      ...
      return l.magFilter = Ht[d.magFilter] || le, l.minFilter = Ht[d.minFilter] || Ve, l.wrapS = qt[d.wrapS] || At, l.wrapT = qt[d.wrapT] || At, l.generateMipmaps = !l.isCompressedTexture && l.minFilter !== oi && l.minFilter !== le, s.associations.set(l, { textures: e }), l;
    }).catch(function() {
      return null;
    });
  ...
  loadImageSource(e, t) {
    ...
    const l = Promise.resolve(a).then(function(h) {
      ...
      return A === !0 && r.revokeObjectURL(a), te(h, n), h.userData.mimeType = n.mimeType || yo(n.uri), h;
    }).catch(function(h) {
  ...
  assignTexture(e, t, i, s) {
    ...
    return this.getDependency("texture", i.index).then(function(n) {
      if (!n) return null;
      if (i.texCoord !== void 0 && i.texCoord > 0 && (n = n.clone(), n.channel = i.texCoord), o.extensions[y.KHR_TEXTURE_TRANSFORM]) {
        const r = i.extensions !== void 0 ? i.extensions[y.KHR_TEXTURE_TRANSFORM] : void 0;
        if (r) {
          const a = o.associations.get(n);
          n = o.extensions[y.KHR_TEXTURE_TRANSFORM].extendTexture(n, r), o.associations.set(n, a);
        }
      }
  ...
  loadMaterial(e) {
    ...
    if (a[y.KHR_MATERIALS_UNLIT]) {
      const h = s[y.KHR_MATERIALS_UNLIT];
      n = h.getMaterialType(), A.push(h.extendParams(r, o, t));
    } else {
      const h = o.pbrMetallicRoughness || {};
      if (r.color = new ne(1, 1, 1), r.opacity = 1, Array.isArray(h.baseColorFactor)) {
    ...
    if (l === Ye.BLEND ? (r.transparent = !0, r.depthWrite = !1) : (r.transparent = !1, l === Ye.MASK && (r.alphaTest = o.alphaCutoff !== void 0 ? o.alphaCutoff : 0.5)), o.normalTexture !== void 0 && n !== fe && (A.push(t.assignTexture(r, "normalMap", o.normalTexture)), r.normalScale = new O(1, 1), o.normalTexture.scale !== void 0)) {
    ...
    if (o.occlusionTexture !== void 0 && n !== fe && (A.push(t.assignTexture(r, "aoMap", o.occlusionTexture)), o.occlusionTexture.strength !== void 0 && (r.aoMapIntensity = o.occlusionTexture.strength)), o.emissiveFactor !== void 0 && n !== fe) {
      ...
      r.emissive = new ne().setRGB(h[0], h[1], h[2], Y);
    }
    return o.emissiveTexture !== void 0 && n !== fe && A.push(t.assignTexture(r, "emissiveMap", o.emissiveTexture, ie)), Promise.all(A).then(function() {
      const h = new n(r);
      return o.name && (h.name = o.name), te(h, o), t.associations.set(h, { materials: e }), o.extensions && re(s, h, o), h;
    });
  }
  /**
  ...
  loadGeometries(e) {
    ...
    function o(r) {
      return i[y.KHR_DRACO_MESH_COMPRESSION].decodePrimitive(r, t).then(function(a) {
        return jt(a, r, t);
      });
    }
    const n = [];
    for (let r = 0, a = e.length; r < a; r++) {
      ...
      if (h)
        ...
        let d;
        A.extensions && A.extensions[y.KHR_DRACO_MESH_COMPRESSION] ? d = o(A) : d = jt(new ri(), A, t), s[l] = { primitive: A, promise: d }, n.push(d);
      }
    }
    ...
    return r.push(t.loadGeometries(n)), Promise.all(r).then(function(a) {
      ...
      for (let g = 0, f = l.length; g < f; g++) {
        ...
        if (I.mode === j.TRIANGLES || I.mode === j.TRIANGLE_STRIP || I.mode === j.TRIANGLE_FAN || I.mode === void 0)
          p = o.isSkinnedMesh === !0 ? new ss(C, m) : new Et(C, m), p.isSkinnedMesh === !0 && p.normalizeSkinWeights(), I.mode === j.TRIANGLE_STRIP ? p.geometry = Ot(p.geometry, si) : I.mode === j.TRIANGLE_FAN && (p.geometry = Ot(p.geometry, at));
        ...
        Object.keys(p.geometry.morphAttributes).length > 0 && Qo(p, o), p.name = t.createUniqueName(o.name || "mesh_" + e), te(p, o), I.extensions && re(s, p, I), t.assignFinalMaterial(p), h.push(p);
      }
  ...
  loadCamera(e) {
    ...
    return i.type === "perspective" ? t = new As(bt.radToDeg(s.yfov), s.aspectRatio || 1, s.znear || 1, s.zfar || 2e6) : i.type === "orthographic" && (t = new cs(-s.xmag, s.xmag, s.ymag, -s.ymag, s.znear, s.zfar)), i.name && (t.name = this.createUniqueName(i.name)), te(t, i), Promise.resolve(t);
  }
  /**
  ...
  loadAnimation(e) {
    ...
    return Promise.all([
      ...
      for (let m = 0, E = d.length; m < E; m++) {
        const b = d[m], B = g[m], Q = f[m], w = C[m], F = I[m];
        if (b === void 0) continue;
        b.updateMatrix && b.updateMatrix();
        const D = i._createAnimationTracks(b, B, Q, w, F);
        if (D)
    ...
    return a && r.push(a), o.camera !== void 0 && r.push(s.getDependency("camera", o.camera).then(function(A) {
      ...
      if (o.isBone === !0 ? l = new ds() : A.length > 1 ? l = new je() : A.length === 1 ? l = A[0] : l = new It(), l !== A[0])
        for (let h = 0, d = A.length; h < d; h++)
          l.add(A[h]);
      if (o.name && (l.userData.name = o.name, l.name = n), te(l, o), o.extensions && re(i, l, o), o.matrix !== void 0) {
        const h = new Re();
  ...
  loadScene(e) {
    ...
    i.name && (o.name = s.createUniqueName(i.name)), te(o, i), i.extensions && re(t, o, i);
    const n = i.nodes || [], r = [];
    for (let a = 0, A = n.length; a < A; a++)
  ...
  _createAnimationTracks(e, t, i, s, o) {
    ...
    oe[o.path] === oe.weights ? e.traverse(function(d) {
...
function jt(c, e, t) {
  ...
  return ct.workingColorSpace !== Y && "COLOR_0" in i && console.warn(`THREE.GLTFLoader: Converting vertex colors from "srgb-linear" to "${ct.workingColorSpace}" not supported.`), te(c, e), vo(c, e, t), Promise.all(s).then(function() {
...
class xo extends Ct {
  ...
  _assignVertexColorSpace(e, t) {
    ...
    for (let s = 0, o = e.count; s < o; s++)
      i.fromBufferAttribute(e, s), ct.colorSpaceToWorking(i, ie), e.setXYZ(s, i.r, i.g, i.b);
  }
  _loadLibrary(e, t) {
    const i = new Ae(this.manager);
...
const To = 0, Kt = 2, ko = 1, zt = 2, Lo = 0, Fo = 1, _o = 10, Go = 0, fi = 9, mi = 15, bi = 16, Ci = 22, Ii = 37, Ei = 43, Bi = 76, Qi = 83, wi = 97, yi = 100, Si = 103, Mi = 109, Po = 131, No = 132, Uo = 133, Oo = 134, Vo = 137, Ho = 138, qo = 141, jo = 142, Ko = 145, zo = 146, vi = 148, xi = 152, Yo = 157, Jo = 158, Di = 165, Ri = 166, Mt = 1000066e3;
class Wo {
  constructor() {
...
function Xo(c) {
  ...
  for (let k = 0; k < C; k++) {
    ...
    64 & V.channelType ? (V.sampleLower = g._nextInt32(), V.sampleUpper = g._nextInt32()) : (V.sampleLower = g._nextUint32(), V.sampleUpper = g._nextUint32()), f.samples[k] = V;
  }
  t.dataFormatDescriptor.length = 0, t.dataFormatDescriptor.push(f);
  const I = new ye(c, a, A, !0);
  for (; I._offset < A; ) {
    const k = I._nextUint32(), V = I._scan(k), se = Yt(V);
    if (t.keyValue[se] = I._nextUint8Array(k - V.byteLength - 1), se.match(/^ktx/i)) {
      const Qe = Yt(t.keyValue[se]);
      t.keyValue[se] = Qe.substring(0, Qe.lastIndexOf("\0"));
    }
    I._skip(k % 4 ? 4 - k % 4 : 0);
  }
  if (h <= 0) return t;
  const p = new ye(c, l, h, !0), m = p._nextUint16(), E = p._nextUint16(), b = p._nextUint32(), B = p._nextUint32(), Q = p._nextUint32(), w = p._nextUint32(), F = [];
  for (let k = 0; k < o; k++) F.push({ imageFlags: p._nextUint32(), rgbSliceByteOffset: p._nextUint32(), rgbSliceByteLength: p._nextUint32(), alphaSliceByteOffset: p._nextUint32(), alphaSliceByteLength: p._nextUint32() });
  const D = l + p._offset, S = D + b, x = S + B, M = x + Q, he = new Uint8Array(c.buffer, c.byteOffset + D, b), J = new Uint8Array(c.buffer, c.byteOffset + S, B), Be = new Uint8Array(c.buffer, c.byteOffset + x, Q), q = new Uint8Array(c.buffer, c.byteOffset + M, w);
  return t.globalData = { endpointCount: m, selectorCount: E, imageDescs: F, endpointsData: he, selectorsData: J, tablesData: Be, extendedData: q }, t;
}
let Xe, ee, ft;
const Ze = { env: { emscripten_notify_memory_growth: function(c) {
  ft = new Uint8Array(ee.exports.memory.buffer);
} } };
class Zo {
  init() {
  ...
  _init(e) {
    ee = e.instance, Ze.env.emscripten_notify_memory_growth(0);
  }
  decode(e, t = 0) {
    if (!ee) throw new Error("ZSTDDecoder: Await .init() before decoding.");
    const i = e.byteLength, s = ee.exports.malloc(i);
    ft.set(e, s), t = t || Number(ee.exports.ZSTD_findDecompressedSize(s, i));
    const o = ee.exports.malloc(t), n = ee.exports.ZSTD_decompress(o, t, s, i), r = ft.slice(o, o + n);
    return ee.exports.free(s), ee.exports.free(o), r;
  }
}
...
class K extends Ct {
  ...
  init() {
    if (!this.transcoderPending) {
      const e = new Ae(this.manager);
      e.setPath(this.transcoderPath), e.setWithCredentials(this.withCredentials);
      const t = e.loadAsync("basis_transcoder.js"), i = new Ae(this.manager);
...
`);
  ...
  _createTextureFrom(e, t) {
    ...
    return h.minFilter = o[0].mipmaps.length === 1 ? le : Ve, h.magFilter = le, h.generateMipmaps = !1, h.needsUpdate = !0, h.colorSpace = Ti(t), h.premultiplyAlpha = !!(l & ko), h;
  }
  /**
   * @private
...
K.BasisWorker = function() {
  ...
  function a(f) {
    ...
    const m = C.getWidth(), E = C.getHeight(), b = C.getLayers() || 1, B = C.getLevels(), Q = C.getFaces(), w = C.getHasAlpha(), F = C.getDFDFlags(), { transcoderFormat: D, engineFormat: S, engineType: x } = h(p, m, E, w);
    if (!m || !E || !B)
    ...
    for (let J = 0; J < Q; J++) {
      ...
      for (let q = 0; q < B; q++) {
        ...
        for (let de = 0; de < b; de++) {
          const ge = C.getImageLevelInfo(q, de, J);
          J === 0 && q === 0 && de === 0 && (ge.origWidth % 4 !== 0 || ge.origHeight % 4 !== 0) && console.warn("THREE.KTX2Loader: ETC1S and UASTC textures should use multiple-of-four dimensions."), B > 1 ? (V = ge.origWidth, se = ge.origHeight) : (V = ge.width, se = ge.height);
          let ue = new Uint8Array(C.getImageTranscodedSizeInBytes(q, de, 0, D));
          const Fi = C.transcodeImage(ue, q, de, J, D, 0, -1, -1);
        ...
        const Qe = g(k);
        Be.push({ data: Qe, width: V, height: se }), he.push(Qe.buffer);
      }
      M.push({ mipmaps: Be, width: m, height: E, format: S, type: x });
    }
    return I(), { faces: M, buffers: he, width: m, height: E, hasAlpha: w, dfdFlags: F, format: S, type: x };
  }
  const A = [
    {
      if: "astcSupported",
...
async function sn(c) {
  ...
  if (tn.has(it[e]))
    ...
    s = new Ai(i, c.pixelWidth, c.pixelHeight), s.minFilter = i.length === 1 ? le : Ve, s.magFilter = le;
  }
...
var on = function() {
  ...
  function a(p, m, E, b, B, Q) {
    var w = o.exports.sbrk, F = E + 3 & -4, D = w(F * b), S = w(B.length), x = new Uint8Array(o.exports.memory.buffer);
    x.set(B, S);
    var M = p(D, E, b, S, B.length);
    if (M == 0 && Q && Q(D, F, b), m.set(x.subarray(D, D + E * b)), w(D - w(0)), M != 0)
  ...
  function f(p) {
    for (var m = "var instance; var ready = WebAssembly.instantiate(new Uint8Array([" + new Uint8Array(r(s)) + "]), {}).then(function(result) { instance = result.instance; instance.exports.__wasm_call_ctors(); });self.onmessage = workerProcess;" + a.toString() + I.toString(), E = new Blob([m], { type: "text/javascript" }), b = URL.createObjectURL(E), B = 0; B < p; ++B)
      h[B] = g(b);
  ...
  function C(p, m, E, b, B) {
    ...
    return new Promise(function(F, D) {
      var S = new Uint8Array(E), x = d++;
      Q.pending += p, Q.requests[x] = { resolve: F, reject: D }, Q.object.postMessage({ id: x, count: p, size: m, source: S, mode: b, filter: B }, [S.buffer]);
    });
  }
  function I(p) {
    n.then(function() {
      var m = p.data;
      try {
        var E = new Uint8Array(m.count * m.size);
        a(o.exports[m.mode], E, m.count, m.size, m.source, o.exports[m.filter]), self.postMessage({ id: m.id, count: m.count, action: "resolve", value: E }, [E.buffer]);
      } catch (b) {
  ...
  return {
    ...
    decodeVertexBuffer: function(p, m, E, b, B) {
      a(o.exports.meshopt_decodeVertexBuffer, p, m, E, b, o.exports[A[B]]);
    },
    decodeIndexBuffer: function(p, m, E, b) {
      a(o.exports.meshopt_decodeIndexBuffer, p, m, E, b);
    },
    decodeIndexSequence: function(p, m, E, b) {
      a(o.exports.meshopt_decodeIndexSequence, p, m, E, b);
    },
    decodeGltfBuffer: function(p, m, E, b, B, Q) {
      a(o.exports[l[B]], p, m, E, b, o.exports[A[Q]]);
    },
    decodeGltfBufferAsync: function(p, m, E, b, B) {
      return h.length > 0 ? C(p, m, E, l[b], A[B]) : n.then(function() {
        var Q = new Uint8Array(p * m);
        return a(o.exports[l[b]], Q, p, m, E, o.exports[A[B]]), Q;
      });
    }
  };
}();
class H {
  ...
  setupKTX2Loader() {
    if (H.sharedKTX2SetupComplete && H.sharedKTX2Loader) {
      this.ktx2Loader = H.sharedKTX2Loader, this.ktx2SetupComplete = !0, this.loader.setKTX2Loader(this.ktx2Loader);
      return;
    }
    try {
      H.sharedKTX2Loader || (H.sharedKTX2Loader = new K(), H.sharedKTX2Loader.setTranscoderPath("https://cdn.jsdelivr.net/npm/three@0.177.0/examples/jsm/libs/basis/")), this.ktx2Loader = H.sharedKTX2Loader, this.renderer && !H.sharedKTX2SetupComplete && (this.ktx2Loader.detectSupport(this.renderer), H.sharedKTX2SetupComplete = !0), this.loader.setKTX2Loader(this.ktx2Loader), this.ktx2SetupComplete = !0;
    } catch (e) {
...
H.sharedKTX2Loader = null;
H.sharedKTX2SetupComplete = !1;
class Ee {
  /**
...
class nn {
  ...
  setupSessionListeners() {
    this.renderer.xr.addEventListener("sessionstart", () => {
      ...
      console.log("🛑 VR session ended"), this.isVRPresenting = !1, this.onSessionEnd && this.onSessionEnd();
    });
  }
  detectQuestDevice() {
    try {
  ...
  applyQuestOptimizations(e) {
    e === "quest2" && (this.camera.far = 20, this.camera.updateProjectionMatrix(), console.log("📊 Quest 2 optimizations applied - render distance limited to 20m"));
  }
  async waitForVRCSS() {
    return new Promise((e) => {
      const t = () => {
  ...
  removeExistingVRButtons() {
    document.querySelectorAll('button.legacy-vr-button, a[href="#VR"]').forEach((t) => {
      try {
        t.parentNode && (t.parentNode.removeChild(t), console.log("🧹 Removed legacy VR button"));
      } catch (i) {
...
async function rn(c) {
  ...
  return await ki(`${c}/profilesList.json`);
}
async function an(c, e, t = null, i = !0) {
  ...
  const n = await ki(o.profilePath);
  let r;
  if (i) {
    let a;
...
class bn {
      ...
      for (let t of e.inputSources)
        if (t.hand && t.handedness) {
          ...
          if (!s || !o || !s.transform || !o.transform)
            ...
            this.handStates[i].pinch = l < 0.025, this.handStates[i].pinch && console.log(`[HandTracking] Pinch detected on ${i} hand. Distance:`, l);
          }
          let n = !0;
          ...
          if (this.handStates[i].fist = n, n && console.log(`[HandTracking] Fist detected on ${i} hand.`), o && r && o.transform && r.transform) {
          ...
          console.log(`[HandTracking] ${i} hand state:`, this.handStates[i]);
        }
    }
  }
  initControllers() {
  ...
  setupControllerEvents() {
    this.controllers.forEach((e, t) => {
      e.addEventListener("connected", (i) => {
        ...
        o !== "tracked-pointer" || r || (s === "left" ? (this.controller1 = e, this.controllerGrip1 = this.controllerGrips[t]) : s === "right" && (this.controller2 = e, this.controllerGrip2 = this.controllerGrips[t]), e.userData.handedness = s, e.userData.initialised = !0, console.log(`✅ ${s} controller connected`));
      }), e.addEventListener("disconnected", () => {
        ...
        e.userData && e.userData.initialised && (console.log(`✊ ${e.userData.handedness} controller squeeze started`), this.onControllerSqueezeStart(e, i));
      }), e.addEventListener("squeezeend", (i) => {
        e.userData && e.userData.initialised && (console.log(`✊ ${e.userData.handedness} controller squeeze ended`), this.onControllerSqueezeEnd(e, i));
      });
    });
  }
  ...
  onControllerSqueezeEnd(e, t) {
    const i = e.userData.handedness;
    console.log(`🛑 ${i} controller squeeze ended - boost deactivated`), this.onSqueezeEnd && this.onSqueezeEnd(i, e, t);
  }
    ...
    if (e) {
      for (let t of e.inputSources)
        if (t.gamepad && t.handedness) {
          ...
          this.buttonStates.get(o) || (console.log(`🎮 ${s} controller detected with ${i.buttons.length} buttons:`), i.buttons.forEach((r, a) => {
            console.log(`  Button[${a}]: pressed=${r.pressed}, touched=${r.touched}, value=${r.value}`);
          }), this.buttonStates.set(o, !0));
          let n = [];
          s === "left" ? n = [4, 5] : s === "right" && (n = [4, 5]), n.forEach((r) => {
            if (i.buttons[r]) {
              const a = i.buttons[r], A = `${s}-${r}`, l = this.buttonStates.get(A) || !1, h = a.pressed;
              h && !l && (console.log(`🎮 ${s} controller button[${r}] pressed for mode toggle!`), this.onModeToggle && this.onModeToggle()), this.buttonStates.set(A, h);
            }
          });
        }
    }
...
class Cn {
  ...
  updateTeleportArc() {
    ...
    if (i.y > 0.3 ? g *= 1 - i.y * 0.5 : i.y < -0.5 && (g *= 1 + Math.abs(i.y) * 0.3), Math.sqrt(i.x * i.x + i.z * i.z) > 0.1) {
      const S = Math.min(1, A / (g * 2));
      g *= S;
    }
    const C = i.x * g, I = Math.max(i.y * g, g * 0.3), p = i.z * g, m = I / Math.abs(d), E = Math.max(m * 2.2, 1.5), b = this.teleportFloorHeight;
    let B = null, Q = !1, w = e.y, F = 0, D = 8;
    for (let S = 0; S <= h; S++) {
      const x = S / h * E, M = new u.Vector3(
        e.x + C * x,
        e.y + I * x + 0.5 * d * x * x,
        e.z + p * x
      );
      Math.abs(M.y - e.y) > D && (M.y = e.y + Math.sign(M.y - e.y) * D), !Q && M.y < w && (Q = !0, F = x), l.push(M);
      const he = Q ? x - F : 0, J = Q && he > 0.1;
      if (!B && J && M.y <= b) {
        if (S > 0) {
          const q = l[S - 1], k = (b - q.y) / (M.y - q.y);
      ...
      if (w = M.y, Math.sqrt(
        ...
        J && (B = new u.Vector3(M.x, b, M.z), l[S] = B, l.length = S + 1);
        break;
      }
    }
    if (!B && l.length > 0) {
      ...
      for (let M = 1; M < l.length; M++)
        l[M].y < S.y && (S = l[M], x = M);
      x > l.length / 3 && (B = new u.Vector3(S.x, b, S.z), l.length = x + 1, l[x] = B);
    }
    if (l.length > 1) {
      const S = new u.CatmullRomCurve3(l), x = new u.TubeGeometry(S, 20, 0.03, 6, !1);
  ...
  calculateAndExecuteTeleport() {
    if (!(!this.teleportController || this.teleportMaxMagnitude < this.teleportThreshold))
      if (this.teleportMarker && this.teleportMarker.visible) {
        ...
        if (i >= 3 && i <= 30) {
          ...
          console.log(`🚫 Invalid teleport distance: ${i.toFixed(2)}m (must be 3-30m)`);
      } else
...
class In {
  ...
  stopMovement() {
    this.isMoving = !1, this.targetSpeed = 0, this.onMovementStop && this.onMovementStop(), console.log("🛑 Movement stopped");
  }
  setTeleportSystem(e) {
...
class Bn {
  ...
  dispose() {
    ...
    this.dpvSound = null, this.dpvHighSound = null, this.ambienceSound = null, this.currentMovementSound = null, this.currentBoostSound = null, this.currentAmbienceSound = null, this.baseGainNode = null, this.boostGainNode = null, this.ambienceGainNode = null, this.soundEnabled = !1, console.log("🔇 VR Sound system disposed");
  }
}
class Qn {
  ...
  ensureComfortSettingsApplied() {
    ...
    const e = this.vrComfort.getSettings();
    e.locomotionMode === "teleport" && (!this.vrTeleport.teleportCurve || !this.vrTeleport.teleportMarker) && this.vrTeleport.setupTeleportation(), (!this.lastComfortLog || Date.now() - this.lastComfortLog > 1e4) && (console.log("🎮 VR comfort mode:", e.locomotionMode === "teleport" ? "SAFETY/COMFORT" : "EXPERIENCED"), this.lastComfortLog = Date.now());
  }
  ...
  dispose() {
    this.vrCore.dispose(), this.vrControllers.dispose(), this.vrTeleport.dispose(), this.vrAudio && this.vrAudio.dispose(), this.onModeToggle = null, this.onMovementStart = null, this.onMovementStop = null, this.onMovementUpdate = null, console.log("🧹 VR Manager disposed completely");
  }
...
const ot = new Te(), Zt = new R(), $t = new R(), _ = new Te(), G = new Te(), W = new Te(), nt = new R(), rt = new Re(), P = new vs(), ei = new R(), Fe = new He(), _e = new Bt(), X = new Te();
let Z, ce;
function ti(c, e, t) {
  return X.set(0, 0, -e, 1).applyMatrix4(c.projectionMatrix), X.multiplyScalar(1 / X.w), X.x = ce / t.width, X.y = ce / t.height, X.applyMatrix4(c.projectionMatrixInverse), X.multiplyScalar(1 / X.w), Math.abs(Math.max(X.x, X.y));
}
function yn(c, e) {
  ...
  for (let r = 0, a = n; r < a; r++) {
    ...
    Z.distanceSqToSegment(P.start, P.end, l, A), l.distanceTo(A) < ce * 0.5 && e.push({
      point: l,
      pointOnLine: A,
...
function Sn(c, e, t) {
  ...
  Z.at(1, W), W.w = 1, W.applyMatrix4(e.matrixWorldInverse), W.applyMatrix4(i), W.multiplyScalar(1 / W.w), W.x *= o.x / 2, W.y *= o.y / 2, W.z = 0, nt.copy(W), rt.multiplyMatrices(e.matrixWorldInverse, n);
  for (let d = 0, g = l; d < g; d++) {
    ...
    P.at(C, ei);
    const I = bt.lerp(_.z, G.z, C), p = I >= -1 && I <= 1, m = nt.distanceTo(ei) < ce * 0.5;
    if (p && m) {
      P.start.fromBufferAttribute(a, d), P.end.fromBufferAttribute(A, d), P.start.applyMatrix4(n), P.end.applyMatrix4(n);
      const E = new R(), b = new R();
      Z.distanceSqToSegment(P.start, P.end, b, E), t.push({
        point: b,
        pointOnLine: E,
        distance: Z.origin.distanceTo(b),
        object: c,
        face: null,
        faceIndex: d,
        uv: null,
...
class Mn extends Et {
   ...
   */
  constructor(e = new Li(), t = new Oe({ color: Math.random() * 16777215 })) {
  ...
  raycast(e, t) {
    ...
    if (i)
      ...
      const h = Math.max(s.near, _e.distanceToPoint(Z.origin));
      A = ti(s, h, a.resolution);
    }
    if (_e.radius += A, Z.intersectsSphere(_e) === !1)
      return;
    ...
    if (i)
      ...
      const h = Math.max(s.near, Fe.distanceToPoint(Z.origin));
      l = ti(s, h, a.resolution);
    }
    Fe.expandByScalar(l), Z.intersectsBox(Fe) !== !1 && (i ? yn(this, t) : Sn(this, s, t));
  }
  onBeforeRender(e) {
...
class ii extends Mn {
   ...
   * @param {LineMaterial} [material] - The line material.
   */
  constructor(e = new mt(), t = new Oe({ color: Math.random() * 16777215 })) {
...
class vn {
  ...
  constructor({ scene: e, camera: t, renderer: i, controls: s, dolly: o, config: n = {}, theme: r = "dark" }) {
    ...
    if (a(), i && i.xr && i.xr.addEventListener && i.xr.addEventListener("sessionstart", a), this.sphereGeometry = new u.SphereGeometry(0.02, 8, 6), this.placedMaterial = new u.MeshBasicMaterial({ color: 16777215 }), this.vrLineMaterial = new Oe({
      color: 16777215,
      linewidth: 3,
      // 3px thick
      transparent: !0,
  ...
  _onVRTriggerUp(e) {
    ...
    if (this.lastTriggerTime && i - this.lastTriggerTime < 200) {
      console.log("🚫 Debounced trigger press");
      return;
    }
    if (this.lastTriggerTime = i, this.measurementSystemEnabled) {
...
class vt {
  ...
  toggle() {
    this.isComfortMode = !this.isComfortMode, this.vrManager && (this.isComfortMode ? this.vrManager.setComfortPreset("max-comfort") : this.vrManager.setComfortPreset("performance")), this.updateVisualState(), console.log(`🎮 Comfort mode: ${this.isComfortMode ? "ON (Safe/Teleport)" : "OFF (Smooth)"}`);
  ...
  dispose() {
    ...
    this.vrManager = null, console.log("🧹 VR Comfort Glyph disposed");
  }
